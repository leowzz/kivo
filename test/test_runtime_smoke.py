...
def test_smoke_requires_expected_protocol_responses() -> None:
    device = FakeSerial(
        [
            b"HELLO 3 esp32s3 luatos-esp32s3-aio test-build 2 1 2\n",
            b"CONFIG_OK 1\n",
...
@pytest.mark.parametrize(
    "hello",
    [
        "HELLO 3 rp2040 luatos-esp32s3-aio test-build 2 1 2",
        "HELLO 3 esp32s3 other-board test-build 2 1 2",
        "HELLO 3 esp32s3 luatos-esp32s3-aio other-build 2 1 2",
        "HELLO 3 esp32s3 luatos-esp32s3-aio test-build",
        "HELLO 3 esp32s3 luatos-esp32s3-aio test-build nope 1",
        "HELLO 3 esp32s3 luatos-esp32s3-aio test-build 2 1",
...
def test_smoke_rejects_wrong_configuration_ack(response: bytes, message: str) -> None:
    responses = [b"HELLO 3 esp32s3 luatos-esp32s3-aio test-build 2 1 2\n"]
