      ...
      <section className="home-main" aria-labelledby="home-title">
        ...
        {!metrics ? <p className="home-unavailable">{t(language, "home.unavailable")}</p> : <>
          <div className="metric-grid">
            ...
            <div className="metric-card"><span className="metric-icon"><Trophy size={16} /></span><span>{t(language, "home.topButton")}</span><strong>{buttonLabel(profile, metrics.topButton?.buttonId)}</strong></div>
          </div>
