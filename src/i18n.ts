...
const zhCN = {
  ...
  "settings.workspaceTitle": "设置",
  "settings.backup": "备份",
  "settings.restore": "恢复",
  "settings.advanced": "高级设置",
  "advanced.profiles": "配置文件",
  "advanced.layout": "按键布局",
  "advanced.io": "I/O 映射",
  "advanced.technical": "技术信息",
  "advanced.protocol": "协议版本",
  "advanced.editorBadge": "当前编辑配置",
  "advanced.usedBy": "已被 {count} 台设备使用",
  "advanced.select": "选择",
  "advanced.selectProfile": "请选择一个配置文件。",
  "advanced.offline": "当前没有已分配设备。可以离线编辑配置；按键学习、实时测试和设备技术信息不可用。",
  "advanced.noDevice": "请选择一台已分配设备以查看技术信息。",
  "layout.title": "按键布局",
  "layout.apply": "应用",
  "layout.edit": "编辑按键布局",
  "profile.create": "新建配置",
  ...
  "setup.skipTest": "跳过测试",
  "setup.retry": "重新检测",
  "setup.openAdvancedIo": "高级 I/O 设置",
  "setup.createFirst": "先新建配置",
  "setup.later": "稍后处理",
  "setup.technicalDetails": "查看技术详情",
  "setup.systemPort": "系统通信端口",
  "setup.selectProfile": "选择按键布局",
  "setup.deviceProfile": "按键布局",
  "setup.next": "下一步",
...
const enUS: Record<MessageKey, string> = {
  ...
  "settings.workspaceTitle": "Settings",
  "settings.backup": "Backup",
  "settings.restore": "Restore",
  "settings.advanced": "Advanced settings",
  "advanced.profiles": "Profiles",
  "advanced.layout": "Key layout",
  "advanced.io": "I/O mapping",
  "advanced.technical": "Technical information",
  "advanced.protocol": "Protocol version",
  "advanced.editorBadge": "Current editor profile",
  "advanced.usedBy": "Used by {count} devices",
  "advanced.select": "Select",
  "advanced.selectProfile": "Select a profile.",
  "advanced.offline": "No assigned device is selected. You can edit this profile offline; key learning, live testing, and device technical details are unavailable.",
  "advanced.noDevice": "Select an assigned device to view technical information.",
  ...
  "setup.newKeyboard": "New keyboard",
  ...
  "setup.openAdvancedIo": "Advanced I/O settings",
  ...
  "setup.selectProfile": "Select key layout",
  "setup.deviceProfile": "Key layout",
  "setup.next": "Next",
