...
const zhCN = {
  ...
  "devices.requiredHardware": "请选择兼容的硬件配置",
  "devices.applyHardware": "应用硬件配置",
  ...
  "hardware.switchNormalState": "常态",
  "hardware.switchEnabledWhen": "以下状态启用按钮",
  "hardware.switchButtons": "受影响的按钮",
  "hardware.switchNormallyOpen": "常开",
  "hardware.switchNormallyClosed": "常闭",
  "hardware.switchOpen": "断开",
  "hardware.switchClosed": "闭合",
...
const enUS: Record<MessageKey, string> = {
  ...
  "devices.requiredHardware": "Select a compatible hardware profile",
  "devices.applyHardware": "Apply hardware profile",
  ...
  "hardware.switchNormalState": "Normal state",
  "hardware.switchEnabledWhen": "Buttons enabled when",
  "hardware.switchButtons": "Affected buttons",
  "hardware.switchNormallyOpen": "Normally open",
  "hardware.switchNormallyClosed": "Normally closed",
  "hardware.switchOpen": "Open",
  "hardware.switchClosed": "Closed",
